...
namespace Exercise_8
{
    class Program
    {
        ...
        static void Main()
        {
            ...
            int input = ReadInt("Выберите действие: ", 1, 3);
        ...
        static void ManualInput()
        {
            ...
            int n = ReadInt("Введите количество вершин в графе: ", 3);
            matrix = new int[n, n];
            ...
            int k = ReadInt("Введите длину цикла, который хотите найти: ", 3, n);
        ...
        static void RandomGraph()
        {
            ...
            Console.Clear();
            PrintTask();
            int size = ReadInt("Введите количество вершин в графе: ", 3);

            matrix = GenerateMatrix(size);
            visitedNodes = new bool[size];
            PrintMatrix();

            int k = ReadInt("Введите длину цикла, который хотите найти: ", 3, size); 
        ...
        {
            Console.WriteLine("Введенная матрица смежности:");
            Console.Write("  ");
            for (int i = 0; i < matrix.GetLength(0); i++)
